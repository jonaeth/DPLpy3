...
python generate_dataset.py \
        ...
        --ouput_train data/${source}/${data_type}_${input_split}_new/${4}/hard/train_${length_train}.pkl \
        --ouput_test data/${source}/${data_type}_${input_split}_new/${4}/hard/test_${length}.pkl \
        --ouput_val data/${source}/${data_type}_${input_split}_new/${4}/hard/validation_${length}.pkl \
        --entity_type ${data_type} \
        --min_length ${length} \
        --html_file data/${source}/${data_type}_${input_split}_new/${4}/hard/sample_${length_train}.html \
