...
python generate_dataset.py \
        ...
        --ouput_train data/${source}/${data_type}_${input_split}_new/${4}/soft_featureset_${5}/train_${length_train}.pkl \
        --ouput_test data/${source}/${data_type}_${input_split}_new/${4}/soft_featureset_${5}/test_${length}.pkl \
        --ouput_val data/${source}/${data_type}_${input_split}_new/${4}/soft_featureset_${5}/validation_${length}.pkl \
        --entity_type ${data_type} \
        --min_length ${length} \
        --html_file data/${source}/${data_type}_${input_split}_new/${4}/soft_featureset_${5}/sample_${length_train}.html \
