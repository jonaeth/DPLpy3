...
parser.add_argument('--word_embedding', type=str, default='/home/SERILOCAL/efi.tsamoura/Downloads/DPL.Release/DPL.Release/EL_release/code_data/data/pubmed_parsed/embedding_vec_gene.pkl',
...
parser.add_argument('--test_data', type=str, default='test_gene_1_soft.pkl',
                    help='test data')
parser.add_argument('--vocab_path', type = str, default="/home/SERILOCAL/efi.tsamoura/Downloads/DPL.Release/DPL.Release/EL_release/code_data/data/pubmed_parsed/vocab_gene.pkl",
                    help='the vocab path')
...
parser.add_argument('--gene_key', type=str,  default='/home/SERILOCAL/efi.tsamoura/Downloads/DPL.Release/DPL.Release/EL_release/code_data/data/gene_key.pkl',
                    help='display the confidence for each prediction')
...
def train_Mstep_Potential(epoch, result):
    ...
    for trial in result.keys():
        ...
        for i in range(len(result[trial]['inc'])):
            ...
            if len(instance['pos_neg_example']) < 10:
